  ...
  return (
    <section className="dashboard-page narrow-page">
      <div className="page-heading">
        <div>
          <p className="eyebrow">{t('Thanks')}</p>
          <h1>{t('Thank you')}</h1>
          <p className="meta-line">{t('COVIDash.it exists thanks to open data, public health datasets, and the original project contributors.')}</p>
        </div>
      </div>
      <p className="body-copy">{t('COVIDash.it makes Italian COVID-19 pandemic and vaccination trends easy to inspect, compare, and share.')}</p>
